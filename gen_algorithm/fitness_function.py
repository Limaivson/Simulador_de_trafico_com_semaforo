...
def fitness_func(light_control: TrafficLight, ways: int):
    ...
    for iteration in range(iter_count):
        if green_time_iterations == 0:
            ...
            t_green = green_time(time_min, time_max, coef, car_count)
            # print(t_green)
...
if __name__ == "__main__":
    print(fitness_func(TrafficLight(15.035208358816782, 36.94170299549921, 1e-07), 3))