...
via_49_1 = ((351, 172.5), (351, 200))

via_46_57 = ((448, 100), (482, 100))
...
sim.create_roads([RUA0_HORIZONTAL_DE, RUA1_HORIZONTAL_DE, RUA2_HORIZONTAL_DE, RUA3_HORIZONTAL_ED, RUA4_HORIZONTAL_ED,
                  ...
                  via_60_4, via_61, via_46_57, via_62
...
sim.create_gen({
    'vehicle_rate': 30,
    'vehicles': [
        [6, {"path": [30, 12, 13, 14, 31, 33, 50, 47, 51, 52, 53, 54, 55, 56, 44, 45, 49, 48]}],
        [4, {"path": [0, 29, 1, 2, 35, 36, 49, 48]}],
        [2, {"path": [26, 25, 2, 35, 36, 49, 48]}],
        [2, {"path": [6, 7, 8, 41, 43, 45, 37, 38, 5, 4, 28, 3]}],
        # [1, {"path": [6, 7, 8, 41, 43, 45, 37, 38, 5, 4, 16, 15]}],
        [2, {"path": [15, 16, 1, 24, 23] if num_aleatorio == 1 else [15, 16, 1, 2, 35, 36, 49, 48]}],
        [2, {"path": [26, 25, 2, 35, 36, 49, 48]}],
        [5, {"path": [32, 34, 39, 40]}],
        [2, {"path": [19, 14, 31, 33, 50, 51, 52, 53, 54, 55, 56, 44, 45, 49, 48]}],
        [2, {"path": [15, 16, 17, 18]}],
        [4, {"path": [-1, 27, 29, 1, 2, 35, 36, 49, 48]}],
        # [2, {"path": []}],
