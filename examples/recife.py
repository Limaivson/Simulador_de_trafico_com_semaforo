...
# # paralela direita
# sim.create_segment((lateral/2, length+intersection_size/2), (lateral/2, intersection_size/2))
# # sim.create_segment((length+intersection_size/2, -lateral/2), (intersection_size/2, -lateral/2))
# sim.create_segment((lateral/2, -length-intersection_size/2), (lateral/2, -intersection_size/2))
# # sim.create_segment((length-intersection_size/2, lateral/2), (-intersection_size/2, lateral/2))
